...
let AuthService = class AuthService {
    ...
    async signup(dto) {
        try {
            ...
            console.log(user);
            return this.signToken(user.id, user.email, user.username, user.isAdmin, user.isConfirm, user.createdAt, user.updatedAt);
        }
        catch (error) {
            throw error;
        }
    ...
    async signToken(userId, email, username, isAdmin, isConfirm, createdAt, updatedAt) {
        const payload = {
            sub: userId,
            email,
            username,
